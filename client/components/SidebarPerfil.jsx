...
const SidebarPerfil = ({ dadosUsuario, estatisticas, modoEdicao, setModoEdicao }) => {
  ...
  return (
    <div className="perfil-sidebar">
      <div className="perfil-info">
       ...
       <p className="info-adicional">Da faculdade {dadosUsuario.instituicao ? dadosUsuario.instituicao : "não informado"}</p>
        <p className="info-adicional">Do curso {dadosUsuario.curso ? dadosUsuario.curso : "não informado"}</p>
